# -*- coding: utf-8 -*-
"""
Created on Sat Aug 15 09:22:50 2020
...
seccion_df = df.loc[49980:50019,:].copy()
...
def llenar_valores_vacios(series, tipo):
    ...
    if lista_valores.empty == True:
        ...
        if(tipo == 'mas_repetido'):
            mas_repetido = lista_valores.index[0]
